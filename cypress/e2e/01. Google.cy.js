describe("Practising on 19th Nov and 22nd Jan 2025", () => {
    ...
    it("My First Test Case", () =>{
        ...
        cy.log(Cypress.env("PG"));              //  This is working $env:CYPRESS_PG="IAMFROMCLI"; npx cypress run --spec "cypress/e2e/01. Google.cy.js" --headed -b chrome
        cy.wait(5000);
    })
})
...
//$env:CYPRESS_PG="IAMFROMCLI"; npx cypress run --spec "cypress/e2e/01. Google.cy.js" --headed -b chrome
