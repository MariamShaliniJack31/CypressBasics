...
describe("MetaDataSync_Redshift", () => {
    ...
    it("Redshift_DeltaFinding", () => {
        ...
        dd_mdscwf.ClickontheElement("rs_meta")
        ...
        //Click rs_meta_Customer schema
  //      dd_mdscwf.ClickontheElement("rs_meta_customer")
  ...
  //      cy.get("canvas").should("be.visible");
        ...
        //Click on NEXT
        dd_mdscwf.ClickontheElement("NEXT");
        cy.wait("@end").its("response.statusCode").should("equal", 200);
